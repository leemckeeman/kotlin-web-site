...
An _exhaustive_ [`when`](control-flow.md#when-expressions-and-statements) statement contains branches for either all possible types or values of its subject, or for some types with an `else` branch. In other words, it covers all possible cases.
